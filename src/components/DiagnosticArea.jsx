...
const API_KEY = "AIzaSyAtFCFH6z2HHojuNz2GSUPdIoXWFwDcFb0";
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-gray-50/50">
            {messages.map((msg, idx) => (
              <div key={idx} className={`flex ${msg.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div
                  className={`max-w-[85%] p-4 rounded-2xl text-base leading-relaxed shadow-sm animate-fade-in-up ${msg.type === 'user'
